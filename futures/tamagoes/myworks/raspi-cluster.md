...
当たり前です。  
[OS](https://e-words.jp/w/OS.html)という、基盤と次に大切なﾔﾂがないのです!  
ところで、ラズパイの標準ディスクは、MiniSD Cardとなっています。  
ですが、実際僕が使用した時にもよく起きましたが、`Kernel panic`というSDカードの耐久性の弱さのためのエラーが吐き出されてしまうことがしばしばあり、最悪の場合起動すらきょかしてくれません。